...
$(document).ready(function () {
    ...
    $("#seasonsList").change(function () {
        ...
        for (let i = 0; i < episodes.length; i++) {
            str += "<div class='card'><div><img class='chapterImg'src='" + (imagePath + episodes[i].still_path) + "' onerror='" + errorPng + "'/></div><div class='info'><h3>" + episodes[i].name + "</h3><p><b>Overview:</b> " + episodes[i].overview + "</p>";
